...
<div class="wrap-body">
	...
	<div class="top">
		<div class="zerogrid">
			<ul class="number f-left">
				<li class="mail"><p><?php echo $contact['email'];?></p></li>
				<li class="phone"><p><?php echo $contact['phone'];?></p></li>
			</ul>
			<ul class="top-social f-right">
				<?php foreach($socialmedia as $media):?>
				<li><a href="<?php echo $media['link'];?>" target="_blank"><i class="<?php echo $media['icon'];?>"></i></a></li>
				<?php endforeach;?>
			</ul>
		</div>
	</div>
	...
	<header>
		<div class="zerogrid">
			<center><div class="logo"><img src="<?php echo $logo['url'];?>"></div></center>
		</div>
	</header>
	...
	<div class="zerogrid">
		<div class="callbacks_container">
			<ul class="rslides" id="slider4">
				<!-- Slider item php code goes here -->
				...
				<?php endforeach;?>
        		<!-- Carousel item php code ends here -->
			</ul>
		</div>
	</div>
